...
////////////////////////////////////////////////////////
    ...
    q.prototype = {
        ...
        fgSegHtml: function(t, e) {
            ...
            return a.unshift("fc-day-grid-event"), !s.allDay && t.isStart && (d = '<span class="fc-time">' + F(i.getEventTimeText(s)) + "</span>"), n = '<span class="fc-title">' + (F(s.title || "") || "&nbsp;") +  "</span>  <button aria-hidden='true' data-dismiss='alert' class='close' ' style='margin:-5px;' type='button'>×</button> ","</span>", '<a class="' + a.join(" ") + '"' + (s.url ? ' href="' + F(s.url) + '"' : "") + (c ? ' style="' + c + '"' : "") + ">" + '<div class="fc-content">' + (r ? n + " " + d : d + " " + n) + "</div>" + (l ? '<div class="fc-resizer"/>' : "") + "</a>"
        },
